...
Try the isolated sample at `/demo`. Demo changes use `demo:garden`; the real map uses `real:garden`.
...
- Verifies the optional $12 one-time season keeper through Sociobot billing.

The free map includes all care, mapping, photo, and export tools. A valid season keeper license adds named season snapshots.
